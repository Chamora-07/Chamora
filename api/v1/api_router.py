...
v1_router.include_router(app_registration_router,
                         prefix="/application", tags=["Application"])
v1_router.include_router(test_script_registration_router,
                         prefix="/test-scripts", tags=["Test Scripts"])
v1_router.include_router(
    anomaly_config_router, prefix="/anomaly-configs", tags=["Anomaly Detection Configs"])
v1_router.include_router(
    test_cycles_router, prefix="/test-cycles", tags=["Test Cycles"])
v1_router.include_router(
    document_router, prefix="/documents", tags=["Documents"])
v1_router.include_router(
    load_testing_router, prefix="/k6", tags=["k6 Testing"])
v1_router.include_router(
    anomaly_flag_router, prefix="/anomaly-flags", tags=["Anomaly Flags"])
